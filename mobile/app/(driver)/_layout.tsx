/**
 * Driver tab tree — Нүүр / Зар / AI / Үнэлгээ / Сошиал.
 *
 * Bottom tab styling matches the design's `.tabbar` — glassy floating
 * pill above the safe-area inset. Icons via `@expo/vector-icons`'s
 * Feather + MaterialCommunityIcons sets.
 */
